...
# UNIQUE IDENTIFIER FOR BUFFED BATTLE MANAGER
const IS_NORMAL_BATTLE_MANAGER = false
const BATTLE_TYPE = "BUFFED"
...
var CardEngineClass = preload("res://levels/buffed battle/card_engine.gd") # Update path
var card_engine: BuffedCardEngine
# Card system
const HAND_LIMIT := 8
...
func start_battle(battleroom, node_info, player_ref):
	print("=== BUFFED BATTLE MANAGER START_BATTLE CALLED ===")
	...
	# Apply a 25% buff to this enemy's core stats compared to normal battles
	# (uses Enemy.apply_buff defined in `entity/enemy/enemy.gd`)
	if enemy_entity.has_method("apply_buff"):
		enemy_entity.apply_buff(1.25)
		print("Buffed enemy stats → HP:", enemy_entity.hp, "Max HP:", enemy_entity.max_hp, "Armor:", enemy_entity.armor, "Buff multiplier:", enemy_entity.buff_multiplier)
...
func generate_random_enemy(node_info):
	var layer_rules = {
		...
		3: ["manananggal"],
		4: ["manananggal","aswang","kapre","white_lady"],
		5: ["manananggal","aswang","kapre","white_lady"],
		6: ["manananggal","aswang","kapre","white_lady"],
		7: ["manananggal","aswang","kapre","white_lady"],
		8: ["manananggal","aswang","kapre","white_lady"],
		9: ["manananggal","aswang","kapre","white_lady"],
		10: ["manananggal","aswang","kapre","white_lady"],
		11: ["manananggal","aswang","kapre","white_lady"],
		12: ["default"]
	}
...
func setup_ui():
	...
	# Reflect buffed stats in the UI
